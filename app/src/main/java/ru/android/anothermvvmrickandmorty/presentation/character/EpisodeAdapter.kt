...
import ru.android.anothermvvmrickandmorty.presentation.utils.pageEpisode

private const val ITEM_VIEW_TYPE_ITEM = 0

class EpisodeAdapter(val clickListener: NumberListener) : ListAdapter<DataItem,
    ...
    class ViewHolder private constructor(private val binding: ItemNumberBinding) :
        ...
        fun bind(clickListener: NumberListener, item: String) {
            binding.data = item.pageEpisode().toString()
